...
* Multi-company record rules now need to have this general form: `['|',('company_id','=',False),('company_id','in',company_ids)]</field>`, and you need to add migration script as well. See https://github.com/OCA/credit-control/pull/54/commits/0960e87eec263747f40f69d95dc3bb58a8053b1d for an example.
